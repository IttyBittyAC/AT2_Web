...
namespace MVCApplication.Data
{
    public class Seeding
    {
        ...
        public async Task SeedAdminUser()
        {
            ...
            // hashing the password should be done properly in a real application, this is just a placeholder
            var hashedPassword = BCrypt.Net.BCrypt.HashPassword("admin123", workFactor: 12);
